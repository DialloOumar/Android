package com.oumardiallo636.gtuc.troskymate.Animation;
...
public class MapAnimator {
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> route) {
        ...
        PolylineOptions optionsBackground = new PolylineOptions().add(route.get(0)).color(GREY).width(10);
        backgroundPolyline = googleMap.addPolyline(optionsBackground);

        optionsForeground = new PolylineOptions().add(route.get(0)).color(GREY).width(10);
